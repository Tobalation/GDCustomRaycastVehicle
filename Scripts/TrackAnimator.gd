...
export(NodePath) var FrontChkRayPath
export(NodePath) var RearChkRayPath
...
var FrontChkRay : RayCast
var RearChkRay : RayCast
...
func _ready() -> void:
	...
	FrontChkRay = get_node(FrontChkRayPath)
	RearChkRay = get_node(RearChkRayPath)
